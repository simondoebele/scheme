...
(2 4)
; expect Error: int is not callable: 2

(2 (print 17))
; expect Error: int is not callable: 2

(cdr cdr)
; expect Error: argument 0 of cdr has wrong type (PrimitiveProcedure)
...
; provided tests should be enough
...
(and True False 42 (/ 1 0))  ; short-circuiting behavior of and
; expect False
...
; Test runs with the web interpreter:

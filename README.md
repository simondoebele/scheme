...
- ok and proj04.ok: the autograder
- questions.scm: contains some helper functions in scheme
- scheme.py: implements the REPL (Read-Eval-Print-Loop) and a evaluator for Scheme expressions
